...
$Email = "$Hdrive\Email\CreateEmail.txt"
...
#Creates email file
"New Account / Re-enable script has run and successfully completed" | out-file -append $Email
"`n" | out-file -append $Email
"`n" | out-file -append $Email
"Your logs can be accessed at the following links:" | out-file -append $Email         
"`n" | out-file -append $Email
"`n" | out-file -append $Email
"`n" | out-file -append $Email
...
"exchange log:" | out-file -append $Email
"`n" | out-file -append $Email         
...
Write-Host "Completed Automatic account create script"

#adds signature to email file
"`n" | out-file -append $Email
"If you require additional assistance, you can open a call with the Service Desk at " | out-file -append $Email
"613-580-2600, or dial ext. 26000 if you have a five-digit extension. You can also " | out-file -append $Email
"send an e-mail to ServDeskCorp@ottawa.ca <mailto:ServDeskCorp@ottawa.ca> " | out-file -append $Email
"with the subject line OPEN CALL. The hours of operation of the Service Desk " | out-file -append $Email
"are between 7 a.m. and 5 p.m. from Monday to Friday. " | out-file -append $Email
"`n" | out-file -append $Email
"`n" | out-file -append $Email
"Thank You" | out-file -append $Email         
"`n" | out-file -append $Email
...
Remove-Item \\dc1fap003\Ito\isd\CSB\ITSSWiki\SD\NTA\Scripts\EDS\Create\Email\CreateEmail.txt
