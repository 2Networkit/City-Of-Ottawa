...
ForEach ($user in $array)
    {
        ...
        "`n" | out-file -append $logfile
        "Emily Yu" | out-file -append $logfile
        "Service Desk Analyst" | out-file -append $logfile
        "Tel. | 613-580-2424 ext. 25880" | out-file -append $logfile
        "Email: Emily.Yu@ottawa.ca" | out-file -append $logfile
