...
"Service Desk Analyst 2 | Analyste 2,  Centre de dépanage" | out-file -append $logfile
"Tel. | tél. 613-580-2400 ext.| poste 25845" | out-file -append $logfile
"Fax | téléc. 613-580-2446" | out-file -append $logfile
"Email | Couriel: " | out-file -append $logfile
"Suzanne.Groulx@ottawa.ca" | out-file -append $logfile
"You now can open and view your own IT support call!  Visit http://its/SelfService/SSDefault.aspx" | out-file -append $logfile
